...
function salvarAvaliacao($id_pergunta, $resposta, $feedback = null) {
    ...
    $query = "INSERT INTO avaliacoes (id_dispositivo, id_pergunta, resposta, feedback_textual, data_hora) 
              VALUES ($id_dispositivo, $id_pergunta, $resposta, $feedback_sql, CURRENT_TIMESTAMP)";
