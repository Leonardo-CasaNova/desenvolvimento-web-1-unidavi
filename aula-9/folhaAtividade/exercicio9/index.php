...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    echo "<h1>Resultado - Juros Compostos</h1>";
    ...
    echo "<tr><th style='padding: 10px; background-color: #ff9800; color: white;'>Parcelas</th><th style='padding: 10px; background-color: #ff9800; color: white;'>Taxa (%)</th><th style='padding: 10px; background-color: #ff9800; color: white;'>Montante Total</th><th style='padding: 10px; background-color: #ff9800; color: white;'>Valor da Parcela</th></tr>";
    
    foreach ($opcoes as $opcao) {
        $montante = calcularJurosCompostos($valorVista, $opcao['taxa'], $opcao['parcelas']);
